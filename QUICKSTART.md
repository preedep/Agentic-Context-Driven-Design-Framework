...
| `{{BASE_PACKAGE}}` | your Java base package |
| `{{BASE_URL_SIT}}` | your SIT environment URL |
| `{{BASE_URL_UAT}}` | your UAT environment URL |
| `{{CONFLUENCE_SPACE}}` | your Confluence space key |
| `{{DB_SCHEMA}}` | your database schema name |
| `{{ERROR_CODE_PREFIX}}` | your error code prefix (e.g., `TRD`, `PAY`) |
| `{{API_BASE_PATH}}` | your API base path |
...
**Example — write backend code (Java Spring Boot):**
```
Load: projects/<your-project>/AGENTS.md
Load: projects/<your-project>/backend/AGENTS.md
Run:  core/java-developer-coding/AGENTS.md
```
